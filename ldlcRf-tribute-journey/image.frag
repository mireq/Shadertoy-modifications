...
const float _FogMul_list[4] = float[4](-0.00100, -0.00800, -0.00100, -0.00100);
const float _FogPow_list[4] = float[4](1.82000, 1.00000, 1.68000, 1.82000);
const float _IncorrectGammaCorrect_list[4] = float[4](1.00000, 1.00000, 1.00000, 1.00000);
const vec3 _LightDir_list[4] = vec3[4](vec3(-0.22632, 0.88099, -0.4155), vec3(-0.23047, 0.87328, -0.42927), vec3(-0.23047, 0.87328, -0.42927), vec3(-0.29644, 0.6859, -0.66458));
const float _Brightness_list[4] = float[4](1.00000, 0.40000, 0.40000, 1.00000);
const float _Contrast_list[4] = float[4](1.00000, 0.83000, 0.82000, 1.00000);
const float _Saturation_list[4] = float[4](1.00000, 1.21000, 1.21000, 1.00000);
const vec3 _SunStar_list[4] = vec3[4](vec3(14.7, 1.47, 0.1), vec3(14.7, 1.47, 0.1), vec3(14.7, 1.47, 0.1), vec3(20.45, 1.49, 0.5));
const float _SunSize_list[4] = float[4](26.00000, 26.00000, 26.00000, 26.09000);
const float _SunScale_list[4] = float[4](15.00000, 15.00000, 15.00000, 15.04000);
const float _ExposureOffset_list[4] = float[4](11.10000, 11.10000, 11.10000, 13.72000);
const float _ExposurePower_list[4] = float[4](0.52000, 0.52000, 0.52000, 0.60000);
const float _ExposureStrength_list[4] = float[4](0.09000, 0.09000, 0.09000, 0.02000);
const RGB _SunColor_list[4] = RGB[4](RGB(1, 0.73741, 0.63971), RGB(1, 0.95441, 0.77206), RGB(0.97059, 0.97059, 0.97059), RGB(0.51471, 0.79919, 1));
const RGB _Zenith_list[4] = RGB[4](RGB(0.67128, 0.94118, 0.69204), RGB(0.77941, 0.5898, 0.41263), RGB(0.98039, 0.83137, 0.53725), RGB(0, 0.053922, 0.16176));
const float _ZenithFallOff_list[4] = float[4](1.42000, 2.36000, 2.36000, 1.42000);
const RGB _Nadir_list[4] = RGB[4](RGB(0, 0, 0), RGB(1, 0.93103, 0), RGB(0, 0, 0), RGB(0.21569, 0.2549, 0.36078));
const float _NadirFallOff_list[4] = float[4](1.91000, 1.91000, 1.91000, 1.91000);
const RGB _Horizon_list[4] = RGB[4](RGB(0.80147, 0.80147, 0.80147), RGB(0.96324, 0.80163, 0.38954), RGB(0.84559, 0.77688, 0.6031), RGB(0.35191, 0.30223, 0.47794));
const vec3 _CharacterAOParams_list[4] = vec3[4](vec3(0.03, 7.36, 0), vec3(0.03, 7.36, 0), vec3(0.03, 7.36, 0), vec3(0.03, 7.36, 0));
const RGB _CharacterMainColor_list[4] = RGB[4](RGB(0.57353, 0.1488, 0.067474), RGB(0.60294, 0.1515, 0.062067), RGB(0.60294, 0.1515, 0.062067), RGB(0.36765, 0.097656, 0.045956));
const RGB _CharacterTerrainCol_list[4] = RGB[4](RGB(0.375, 0.21885, 0.15993), RGB(0.35294, 0.16016, 0.12197), RGB(0.5, 0.3404, 0.12868), RGB(0.083261, 0.11379, 0.16176));
const RGB _CharacterCloakDarkColor_list[4] = RGB[4](RGB(0.38971, 0.10735, 0.054444), RGB(0.25735, 0.028557, 0.0056769), RGB(0.31618, 0.14042, 0.039522), RGB(0.073529, 0.011604, 0));
const RGB _CharacterYellowColor_list[4] = RGB[4](RGB(0.64706, 0.35588, 0), RGB(0.88971, 0.34975, 0), RGB(0.64706, 0.30233, 0), RGB(0.60294, 0.33162, 0));
const RGB _CharacterWhiteColor_list[4] = RGB[4](RGB(1, 1, 1), RGB(0.9928, 1, 0.47794), RGB(1, 1, 1), RGB(1, 1, 1));
const float _CharacterBloomScale_list[4] = float[4](0.87000, 0.70000, 0.87000, 0.87000);
const float _CharacterDiffScale_list[4] = float[4](1.50000, 1.50000, 1.50000, 1.50000);
const float _CharacterFreScale_list[4] = float[4](1.77000, 1.77000, 1.77000, 1.77000);
const float _CharacterFrePower_list[4] = float[4](3.84000, 3.84000, 3.84000, 19.83000);
const float _CharacterFogScale_list[4] = float[4](20.00000, 4.55000, 12.47000, 60.00000);
const float _CloudTransparencyMul_list[4] = float[4](0.90000, 0.90000, 0.80000, 0.90000);
const RGB _CloudCol_list[4] = RGB[4](RGB(1, 0.96957, 0.88235), RGB(1, 0.84926, 0.69853), RGB(0.99216, 0.9451, 0.76471), RGB(0.0069204, 0.15969, 0.23529));
const RGB _BackCloudCol_list[4] = RGB[4](RGB(0.66176, 0.64807, 0.62284), RGB(0.66176, 0.64807, 0.62284), RGB(0.66176, 0.64807, 0.62284), RGB(0, 0.10969, 0.15441));
const RGB _CloudSpecCol_list[4] = RGB[4](RGB(0.17647, 0.062284, 0.062284), RGB(0.17647, 0.062284, 0.062284), RGB(0.17647, 0.062284, 0.062284), RGB(0.11765, 0.11765, 0.11765));
const RGB _BackCloudSpecCol_list[4] = RGB[4](RGB(0.11029, 0.05193, 0.020275), RGB(0.11029, 0.05193, 0.020275), RGB(0.11029, 0.05193, 0.020275), RGB(0.080882, 0.080882, 0.080882));
const float _CloudFogStrength_list[4] = float[4](0.50000, 0.50000, 0.50000, 0.50000);
const RGB _TombMainColor_list[4] = RGB[4](RGB(0.47735, 0.59559, 0.49705), RGB(0.64706, 0.38039, 0.27451), RGB(0.94118, 0.82759, 0.45675), RGB(0.23789, 0.27707, 0.40441));
const RGB _TombScarfColor_list[4] = RGB[4](RGB(0.45588, 0.093858, 0.093858), RGB(0.38971, 0.10029, 0.10029), RGB(0.44118, 0.19989, 0.14922), RGB(0.066176, 0, 0.034229));
const RGB _PyramidCol_list[4] = RGB[4](RGB(0.30147, 0.28329, 0.21059), RGB(0.69853, 0.40389, 0.22086), RGB(0.92647, 0.73579, 0.3338), RGB(0, 0, 0));
const vec2 _PyramidHeightFog_list[4] = vec2[4](vec2(38.66, 1.05), vec2(38.66, 1.3), vec2(38.66, 4.65), vec2(38.66, 1.92));
const RGB _TerrainCol_list[4] = RGB[4](RGB(0.76863, 0.55294, 0.47059), RGB(0.56618, 0.29249, 0.1915), RGB(0.71324, 0.5076, 0.236), RGB(0, 0.058832, 0.10294));
const RGB _TerrainSpecColor_list[4] = RGB[4](RGB(0.32353, 0.32123, 0.31877), RGB(1, 0.77637, 0.53676), RGB(0.32353, 0.32123, 0.31877), RGB(0.24622, 0.29188, 0.33824));
const float _TerrainSpecPower_list[4] = float[4](55.35000, 55.35000, 55.35000, 55.35000);
const float _TerrainSpecStrength_list[4] = float[4](1.56000, 1.56000, 0.03000, 1.56000);
const float _TerrainGlitterRep_list[4] = float[4](7.00000, 7.00000, 7.00000, 7.00000);
const float _TerrainGlitterPower_list[4] = float[4](1.94000, 3.20000, 3.20000, 1.94000);
const RGB _TerrainRimColor_list[4] = RGB[4](RGB(0, 0, 0), RGB(0.16176, 0.13131, 0.098724), RGB(0, 0, 0), RGB(0.091021, 0.057093, 0.16176));
const float _TerrainRimPower_list[4] = float[4](5.59000, 5.59000, 5.59000, 5.59000);
const float _TerrainRimStrength_list[4] = float[4](2.00000, 1.61000, 1.61000, 2.00000);
const float _TerrainRimSpecPower_list[4] = float[4](1.46000, 2.88000, 0.38000, 1.46000);
const float _TerrainFogPower_list[4] = float[4](2.11000, 2.11000, 2.11000, 2.11000);
const vec4 _TerrainShadowParams_list[4] = vec4[4](vec4(0.12, 5.2, 88.7, 0.28), vec4(0.12, 5.2, 88.7, 0.28), vec4(0.12, 5.2, 88.7, 0.28), vec4(0.12, 5.2, 88.7, 0.37));
const vec3 _TerrainAOParams_list[4] = vec3[4](vec3(0.01, 0.02, 2), vec3(0.01, 0.02, 2), vec3(0.01, 0.02, 2), vec3(0.01, 0.02, 2));
const RGB _TerrainShadowColor_list[4] = RGB[4](RGB(0.40441, 0.34106, 0.31818), RGB(0.48529, 0.13282, 0), RGB(0.66912, 0.52969, 0.369), RGB(0.11029, 0.11029, 0.11029));
const RGB _TerrainDistanceShadowColor_list[4] = RGB[4](RGB(1, 0.81471, 0.74265), RGB(0.70588, 0.4644, 0.36851), RGB(1, 0.75466, 0.43382), RGB(0.0034061, 0.073181, 0.15441));
const float _TerrainDistanceShadowPower_list[4] = float[4](0.11000, 0.11000, 0.11000, 0.06000);
const RGB _FlyingHelperMainColor_list[4] = RGB[4](RGB(0.80882, 0.11671, 0.017842), RGB(0.85294, 0.11759, 0.012543), RGB(0.91912, 0.30412, 0.21626), RGB(0.12661, 0.004109, 0.13971));
const RGB _FlyingHelperCloakDarkColor_list[4] = RGB[4](RGB(1, 0.090909, 0), RGB(1, 0.090909, 0), RGB(1, 0.090909, 0), RGB(1, 0.090909, 0));
const RGB _FlyingHelperYellowColor_list[4] = RGB[4](RGB(1, 0.56187, 0.0073529), RGB(1, 0.3931, 0), RGB(0.98529, 0.60477, 0.12316), RGB(0.48529, 0.2711, 0));
const RGB _FlyingHelperWhiteColor_list[4] = RGB[4](RGB(1, 1, 1), RGB(1, 1, 1), RGB(1, 1, 1), RGB(1, 1, 1));
const float _FlyingHelperBloomScale_list[4] = float[4](1.91000, 2.61000, 1.91000, 1.91000);
const float _FlyingHelperFrePower_list[4] = float[4](1.00000, 1.00000, 1.00000, 1.00000);
const float _FlyingHelperFreScale_list[4] = float[4](0.85000, 0.85000, 0.85000, 0.85000);
const float _FlyingHelperFogScale_list[4] = float[4](4.00000, 1.75000, 4.00000, 5.51000);


float smooth_fade(float time, float start, float end, float fade_time, float cycle)
{
	time = mod(time, cycle);

	float fade_in = smoothstep(start - fade_time, start, time);
	float fade_out = 1.0 - smoothstep(end - fade_time, end, time);
	float fade_in_overflow = smoothstep(start - fade_time, start, time - cycle);

	return max(min(fade_in, fade_out), fade_in_overflow);
}

const float color_duration = 8.0;
const float color_fade_time = color_duration / 4.0;
float time = iTime + color_fade_time;
float color_scheme[4] = float[4](
	smooth_fade(time, color_duration * 0.0, color_duration * 0.0 + color_duration, color_fade_time, color_duration * 4.0),
	smooth_fade(time, color_duration * 1.0, color_duration * 1.0 + color_duration, color_fade_time, color_duration * 4.0),
	smooth_fade(time, color_duration * 2.0, color_duration * 2.0 + color_duration, color_fade_time, color_duration * 4.0),
	smooth_fade(time, color_duration * 3.0, color_duration * 3.0 + color_duration, color_fade_time, color_duration * 4.0)
);

float _FogMul = color_scheme[0] * _FogMul_list[0] + color_scheme[1] * _FogMul_list[1] +  color_scheme[2] * _FogMul_list[2] + color_scheme[3] * _FogMul_list[3];
float _FogPow = color_scheme[0] * _FogPow_list[0] + color_scheme[1] * _FogPow_list[1] +  color_scheme[2] * _FogPow_list[2] + color_scheme[3] * _FogPow_list[3];
float _IncorrectGammaCorrect = color_scheme[0] * _IncorrectGammaCorrect_list[0] + color_scheme[1] * _IncorrectGammaCorrect_list[1] +  color_scheme[2] * _IncorrectGammaCorrect_list[2] + color_scheme[3] * _IncorrectGammaCorrect_list[3];
vec3 _LightDir = color_scheme[0] * _LightDir_list[0] + color_scheme[1] * _LightDir_list[1] +  color_scheme[2] * _LightDir_list[2] + color_scheme[3] * _LightDir_list[3];
float _Brightness = color_scheme[0] * _Brightness_list[0] + color_scheme[1] * _Brightness_list[1] +  color_scheme[2] * _Brightness_list[2] + color_scheme[3] * _Brightness_list[3];
float _Contrast = color_scheme[0] * _Contrast_list[0] + color_scheme[1] * _Contrast_list[1] +  color_scheme[2] * _Contrast_list[2] + color_scheme[3] * _Contrast_list[3];
float _Saturation = color_scheme[0] * _Saturation_list[0] + color_scheme[1] * _Saturation_list[1] +  color_scheme[2] * _Saturation_list[2] + color_scheme[3] * _Saturation_list[3];
vec3 _SunStar = color_scheme[0] * _SunStar_list[0] + color_scheme[1] * _SunStar_list[1] +  color_scheme[2] * _SunStar_list[2] + color_scheme[3] * _SunStar_list[3];
float _SunSize = color_scheme[0] * _SunSize_list[0] + color_scheme[1] * _SunSize_list[1] +  color_scheme[2] * _SunSize_list[2] + color_scheme[3] * _SunSize_list[3];
float _SunScale = color_scheme[0] * _SunScale_list[0] + color_scheme[1] * _SunScale_list[1] +  color_scheme[2] * _SunScale_list[2] + color_scheme[3] * _SunScale_list[3];
float _ExposureOffset = color_scheme[0] * _ExposureOffset_list[0] + color_scheme[1] * _ExposureOffset_list[1] +  color_scheme[2] * _ExposureOffset_list[2] + color_scheme[3] * _ExposureOffset_list[3];
float _ExposurePower = color_scheme[0] * _ExposurePower_list[0] + color_scheme[1] * _ExposurePower_list[1] +  color_scheme[2] * _ExposurePower_list[2] + color_scheme[3] * _ExposurePower_list[3];
float _ExposureStrength = color_scheme[0] * _ExposureStrength_list[0] + color_scheme[1] * _ExposureStrength_list[1] +  color_scheme[2] * _ExposureStrength_list[2] + color_scheme[3] * _ExposureStrength_list[3];
RGB _SunColor = color_scheme[0] * _SunColor_list[0] + color_scheme[1] * _SunColor_list[1] +  color_scheme[2] * _SunColor_list[2] + color_scheme[3] * _SunColor_list[3];
RGB _Zenith = color_scheme[0] * _Zenith_list[0] + color_scheme[1] * _Zenith_list[1] +  color_scheme[2] * _Zenith_list[2] + color_scheme[3] * _Zenith_list[3];
float _ZenithFallOff = color_scheme[0] * _ZenithFallOff_list[0] + color_scheme[1] * _ZenithFallOff_list[1] +  color_scheme[2] * _ZenithFallOff_list[2] + color_scheme[3] * _ZenithFallOff_list[3];
RGB _Nadir = color_scheme[0] * _Nadir_list[0] + color_scheme[1] * _Nadir_list[1] +  color_scheme[2] * _Nadir_list[2] + color_scheme[3] * _Nadir_list[3];
float _NadirFallOff = color_scheme[0] * _NadirFallOff_list[0] + color_scheme[1] * _NadirFallOff_list[1] +  color_scheme[2] * _NadirFallOff_list[2] + color_scheme[3] * _NadirFallOff_list[3];
RGB _Horizon = color_scheme[0] * _Horizon_list[0] + color_scheme[1] * _Horizon_list[1] +  color_scheme[2] * _Horizon_list[2] + color_scheme[3] * _Horizon_list[3];
vec3 _CharacterAOParams = color_scheme[0] * _CharacterAOParams_list[0] + color_scheme[1] * _CharacterAOParams_list[1] +  color_scheme[2] * _CharacterAOParams_list[2] + color_scheme[3] * _CharacterAOParams_list[3];
RGB _CharacterMainColor = color_scheme[0] * _CharacterMainColor_list[0] + color_scheme[1] * _CharacterMainColor_list[1] +  color_scheme[2] * _CharacterMainColor_list[2] + color_scheme[3] * _CharacterMainColor_list[3];
RGB _CharacterTerrainCol = color_scheme[0] * _CharacterTerrainCol_list[0] + color_scheme[1] * _CharacterTerrainCol_list[1] +  color_scheme[2] * _CharacterTerrainCol_list[2] + color_scheme[3] * _CharacterTerrainCol_list[3];
RGB _CharacterCloakDarkColor = color_scheme[0] * _CharacterCloakDarkColor_list[0] + color_scheme[1] * _CharacterCloakDarkColor_list[1] +  color_scheme[2] * _CharacterCloakDarkColor_list[2] + color_scheme[3] * _CharacterCloakDarkColor_list[3];
RGB _CharacterYellowColor = color_scheme[0] * _CharacterYellowColor_list[0] + color_scheme[1] * _CharacterYellowColor_list[1] +  color_scheme[2] * _CharacterYellowColor_list[2] + color_scheme[3] * _CharacterYellowColor_list[3];
RGB _CharacterWhiteColor = color_scheme[0] * _CharacterWhiteColor_list[0] + color_scheme[1] * _CharacterWhiteColor_list[1] +  color_scheme[2] * _CharacterWhiteColor_list[2] + color_scheme[3] * _CharacterWhiteColor_list[3];
float _CharacterBloomScale = color_scheme[0] * _CharacterBloomScale_list[0] + color_scheme[1] * _CharacterBloomScale_list[1] +  color_scheme[2] * _CharacterBloomScale_list[2] + color_scheme[3] * _CharacterBloomScale_list[3];
float _CharacterDiffScale = color_scheme[0] * _CharacterDiffScale_list[0] + color_scheme[1] * _CharacterDiffScale_list[1] +  color_scheme[2] * _CharacterDiffScale_list[2] + color_scheme[3] * _CharacterDiffScale_list[3];
float _CharacterFreScale = color_scheme[0] * _CharacterFreScale_list[0] + color_scheme[1] * _CharacterFreScale_list[1] +  color_scheme[2] * _CharacterFreScale_list[2] + color_scheme[3] * _CharacterFreScale_list[3];
float _CharacterFrePower = color_scheme[0] * _CharacterFrePower_list[0] + color_scheme[1] * _CharacterFrePower_list[1] +  color_scheme[2] * _CharacterFrePower_list[2] + color_scheme[3] * _CharacterFrePower_list[3];
float _CharacterFogScale = color_scheme[0] * _CharacterFogScale_list[0] + color_scheme[1] * _CharacterFogScale_list[1] +  color_scheme[2] * _CharacterFogScale_list[2] + color_scheme[3] * _CharacterFogScale_list[3];
float _CloudTransparencyMul = color_scheme[0] * _CloudTransparencyMul_list[0] + color_scheme[1] * _CloudTransparencyMul_list[1] +  color_scheme[2] * _CloudTransparencyMul_list[2] + color_scheme[3] * _CloudTransparencyMul_list[3];
RGB _CloudCol = color_scheme[0] * _CloudCol_list[0] + color_scheme[1] * _CloudCol_list[1] +  color_scheme[2] * _CloudCol_list[2] + color_scheme[3] * _CloudCol_list[3];
RGB _BackCloudCol = color_scheme[0] * _BackCloudCol_list[0] + color_scheme[1] * _BackCloudCol_list[1] +  color_scheme[2] * _BackCloudCol_list[2] + color_scheme[3] * _BackCloudCol_list[3];
RGB _CloudSpecCol = color_scheme[0] * _CloudSpecCol_list[0] + color_scheme[1] * _CloudSpecCol_list[1] +  color_scheme[2] * _CloudSpecCol_list[2] + color_scheme[3] * _CloudSpecCol_list[3];
RGB _BackCloudSpecCol = color_scheme[0] * _BackCloudSpecCol_list[0] + color_scheme[1] * _BackCloudSpecCol_list[1] +  color_scheme[2] * _BackCloudSpecCol_list[2] + color_scheme[3] * _BackCloudSpecCol_list[3];
float _CloudFogStrength = color_scheme[0] * _CloudFogStrength_list[0] + color_scheme[1] * _CloudFogStrength_list[1] +  color_scheme[2] * _CloudFogStrength_list[2] + color_scheme[3] * _CloudFogStrength_list[3];
RGB _TombMainColor = color_scheme[0] * _TombMainColor_list[0] + color_scheme[1] * _TombMainColor_list[1] +  color_scheme[2] * _TombMainColor_list[2] + color_scheme[3] * _TombMainColor_list[3];
RGB _TombScarfColor = color_scheme[0] * _TombScarfColor_list[0] + color_scheme[1] * _TombScarfColor_list[1] +  color_scheme[2] * _TombScarfColor_list[2] + color_scheme[3] * _TombScarfColor_list[3];
RGB _PyramidCol = color_scheme[0] * _PyramidCol_list[0] + color_scheme[1] * _PyramidCol_list[1] +  color_scheme[2] * _PyramidCol_list[2] + color_scheme[3] * _PyramidCol_list[3];
vec2 _PyramidHeightFog = color_scheme[0] * _PyramidHeightFog_list[0] + color_scheme[1] * _PyramidHeightFog_list[1] +  color_scheme[2] * _PyramidHeightFog_list[2] + color_scheme[3] * _PyramidHeightFog_list[3];
RGB _TerrainCol = color_scheme[0] * _TerrainCol_list[0] + color_scheme[1] * _TerrainCol_list[1] +  color_scheme[2] * _TerrainCol_list[2] + color_scheme[3] * _TerrainCol_list[3];
RGB _TerrainSpecColor = color_scheme[0] * _TerrainSpecColor_list[0] + color_scheme[1] * _TerrainSpecColor_list[1] +  color_scheme[2] * _TerrainSpecColor_list[2] + color_scheme[3] * _TerrainSpecColor_list[3];
float _TerrainSpecPower = color_scheme[0] * _TerrainSpecPower_list[0] + color_scheme[1] * _TerrainSpecPower_list[1] +  color_scheme[2] * _TerrainSpecPower_list[2] + color_scheme[3] * _TerrainSpecPower_list[3];
float _TerrainSpecStrength = color_scheme[0] * _TerrainSpecStrength_list[0] + color_scheme[1] * _TerrainSpecStrength_list[1] +  color_scheme[2] * _TerrainSpecStrength_list[2] + color_scheme[3] * _TerrainSpecStrength_list[3];
float _TerrainGlitterRep = color_scheme[0] * _TerrainGlitterRep_list[0] + color_scheme[1] * _TerrainGlitterRep_list[1] +  color_scheme[2] * _TerrainGlitterRep_list[2] + color_scheme[3] * _TerrainGlitterRep_list[3];
float _TerrainGlitterPower = color_scheme[0] * _TerrainGlitterPower_list[0] + color_scheme[1] * _TerrainGlitterPower_list[1] +  color_scheme[2] * _TerrainGlitterPower_list[2] + color_scheme[3] * _TerrainGlitterPower_list[3];
RGB _TerrainRimColor = color_scheme[0] * _TerrainRimColor_list[0] + color_scheme[1] * _TerrainRimColor_list[1] +  color_scheme[2] * _TerrainRimColor_list[2] + color_scheme[3] * _TerrainRimColor_list[3];
float _TerrainRimPower = color_scheme[0] * _TerrainRimPower_list[0] + color_scheme[1] * _TerrainRimPower_list[1] +  color_scheme[2] * _TerrainRimPower_list[2] + color_scheme[3] * _TerrainRimPower_list[3];
float _TerrainRimStrength = color_scheme[0] * _TerrainRimStrength_list[0] + color_scheme[1] * _TerrainRimStrength_list[1] +  color_scheme[2] * _TerrainRimStrength_list[2] + color_scheme[3] * _TerrainRimStrength_list[3];
float _TerrainRimSpecPower = color_scheme[0] * _TerrainRimSpecPower_list[0] + color_scheme[1] * _TerrainRimSpecPower_list[1] +  color_scheme[2] * _TerrainRimSpecPower_list[2] + color_scheme[3] * _TerrainRimSpecPower_list[3];
float _TerrainFogPower = color_scheme[0] * _TerrainFogPower_list[0] + color_scheme[1] * _TerrainFogPower_list[1] +  color_scheme[2] * _TerrainFogPower_list[2] + color_scheme[3] * _TerrainFogPower_list[3];
vec4 _TerrainShadowParams = color_scheme[0] * _TerrainShadowParams_list[0] + color_scheme[1] * _TerrainShadowParams_list[1] +  color_scheme[2] * _TerrainShadowParams_list[2] + color_scheme[3] * _TerrainShadowParams_list[3];
vec3 _TerrainAOParams = color_scheme[0] * _TerrainAOParams_list[0] + color_scheme[1] * _TerrainAOParams_list[1] +  color_scheme[2] * _TerrainAOParams_list[2] + color_scheme[3] * _TerrainAOParams_list[3];
RGB _TerrainShadowColor = color_scheme[0] * _TerrainShadowColor_list[0] + color_scheme[1] * _TerrainShadowColor_list[1] +  color_scheme[2] * _TerrainShadowColor_list[2] + color_scheme[3] * _TerrainShadowColor_list[3];
RGB _TerrainDistanceShadowColor = color_scheme[0] * _TerrainDistanceShadowColor_list[0] + color_scheme[1] * _TerrainDistanceShadowColor_list[1] +  color_scheme[2] * _TerrainDistanceShadowColor_list[2] + color_scheme[3] * _TerrainDistanceShadowColor_list[3];
float _TerrainDistanceShadowPower = color_scheme[0] * _TerrainDistanceShadowPower_list[0] + color_scheme[1] * _TerrainDistanceShadowPower_list[1] +  color_scheme[2] * _TerrainDistanceShadowPower_list[2] + color_scheme[3] * _TerrainDistanceShadowPower_list[3];
RGB _FlyingHelperMainColor = color_scheme[0] * _FlyingHelperMainColor_list[0] + color_scheme[1] * _FlyingHelperMainColor_list[1] +  color_scheme[2] * _FlyingHelperMainColor_list[2] + color_scheme[3] * _FlyingHelperMainColor_list[3];
RGB _FlyingHelperCloakDarkColor = color_scheme[0] * _FlyingHelperCloakDarkColor_list[0] + color_scheme[1] * _FlyingHelperCloakDarkColor_list[1] +  color_scheme[2] * _FlyingHelperCloakDarkColor_list[2] + color_scheme[3] * _FlyingHelperCloakDarkColor_list[3];
RGB _FlyingHelperYellowColor = color_scheme[0] * _FlyingHelperYellowColor_list[0] + color_scheme[1] * _FlyingHelperYellowColor_list[1] +  color_scheme[2] * _FlyingHelperYellowColor_list[2] + color_scheme[3] * _FlyingHelperYellowColor_list[3];
RGB _FlyingHelperWhiteColor = color_scheme[0] * _FlyingHelperWhiteColor_list[0] + color_scheme[1] * _FlyingHelperWhiteColor_list[1] +  color_scheme[2] * _FlyingHelperWhiteColor_list[2] + color_scheme[3] * _FlyingHelperWhiteColor_list[3];
float _FlyingHelperBloomScale = color_scheme[0] * _FlyingHelperBloomScale_list[0] + color_scheme[1] * _FlyingHelperBloomScale_list[1] +  color_scheme[2] * _FlyingHelperBloomScale_list[2] + color_scheme[3] * _FlyingHelperBloomScale_list[3];
float _FlyingHelperFrePower = color_scheme[0] * _FlyingHelperFrePower_list[0] + color_scheme[1] * _FlyingHelperFrePower_list[1] +  color_scheme[2] * _FlyingHelperFrePower_list[2] + color_scheme[3] * _FlyingHelperFrePower_list[3];
float _FlyingHelperFreScale = color_scheme[0] * _FlyingHelperFreScale_list[0] + color_scheme[1] * _FlyingHelperFreScale_list[1] +  color_scheme[2] * _FlyingHelperFreScale_list[2] + color_scheme[3] * _FlyingHelperFreScale_list[3];
float _FlyingHelperFogScale = color_scheme[0] * _FlyingHelperFogScale_list[0] + color_scheme[1] * _FlyingHelperFogScale_list[1] +  color_scheme[2] * _FlyingHelperFogScale_list[2] + color_scheme[3] * _FlyingHelperFogScale_list[3];
